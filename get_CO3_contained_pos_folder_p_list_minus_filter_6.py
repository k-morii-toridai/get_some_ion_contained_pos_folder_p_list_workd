...
from package_bond_search_algorithm.algolithm_bond_search_for_CO3_minus_filter_6 import concat_filter
...
saved_npy_fname = 'CO3_contained_poscar_folder_path_list_minus_filter_6.npy'
np.save(saved_npy_fname, ion_contained_poscar_folder_path_list)
# print parcentage
print(f"len(ion_contained_poscar_folder_path_list_minus_filter_6)/len(C_O_existed_poscar_folder_path_list) :\
